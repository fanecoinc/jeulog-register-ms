...
INSERT INTO "new_TruckSet" ("blockedDescription", "cartOneId", "cartThreeId", "cartTwoId", "createdAt", "dedicatedFleet", "deletedAt", "id", "isBlocked", "ownerId", "status", "truckTractorId", "updatedAt") SELECT "blockedDescription", "cartOneId", "cartThreeId", "cartTwoId", "createdAt", "dedicatedFleet", "deletedAt", "id", "isBlocked", "ownerId", "status", "truckTractorId", "updatedAt" FROM "TruckSet";
DROP TABLE "TruckSet";
